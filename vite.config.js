...
// Custom trackers (/t/<id>) have no file of their own: the same page serves
// them all. Production does this with rewrites in vercel.json; this plugin
// does the same for dev and preview.
