...
- **Not verified on the final wording**: a third full run failed partway because **the Anthropic account ran out of credit** (every call answered "credit balance too low"). Its valid part (single, multi, typo 9/10 with the dentist typo, new 32/32) passed; the 7 last ambiguous and all 14 adversarial phrases were not actually tested on the final wording. One more full run (about a quarter of a dollar) is needed once credit is added, so **TP4 and P9.4 stay unchecked**.
