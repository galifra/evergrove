...
export const BUILTIN_TRACKERS = [
  {
    ...
    fields: [
      ...
      f.num('sets', 'Sets (lifting)', { min: 1, max: 50 }),
      f.num('reps', 'Reps per set', { min: 1, max: 500 }),
      f.num('weight', 'Weight per rep (lb)', { min: 0, max: 2000 }),
      f.text('notes', 'Notes'),
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      f.num('value', 'Number (hours, weight, cups, or calories)'),
      f.num('calories', 'Calories (meal)', { min: 0, max: 10000 }),
      f.num('protein', 'Protein g (meal)', { min: 0, max: 1000 }),
      f.num('carbs', 'Carbs g (meal)', { min: 0, max: 1500 }),
      f.num('fat', 'Fat g (meal)', { min: 0, max: 1000 }),
      f.text('notes', 'Notes'),
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      f.text('remember', 'Something to remember (reviewed at growing gaps)'),
      f.sel('type', 'Kind', ['study', 'review']),
      f.text('notes', 'Notes'),
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      f.text('title', 'What (role or win)', { required: true }),
      f.text('company', 'Company'),
      f.sel('stage', 'Application stage', ['applied', 'screening', 'interview', 'offer', 'accepted', 'rejected']),
      f.text('notes', 'Notes'),
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      f.num('income', 'Income earned ($)', { min: 0, max: 10000000 }),
      f.text('notes', 'Notes'),
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      f.num('budget', 'Trip budget ($)', { min: 0, max: 10000000 }),
      f.text('notes', 'Notes'),
    ],
